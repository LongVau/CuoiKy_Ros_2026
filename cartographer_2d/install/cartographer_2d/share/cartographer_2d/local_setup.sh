...
: ${AMENT_CURRENT_PREFIX:="/root/humble_ws/src/cartographer_2d/install/cartographer_2d"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cartographer_2d/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cartographer_2d/environment/path.sh"
